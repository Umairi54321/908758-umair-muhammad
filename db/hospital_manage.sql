...
--
-- Host: 127.0.0.1
-- Generation Time: May 10, 2025 at 06:52 PM
...
(1, 'Admin', 'admin@example.com', '$2y$10$kKzpxc42q5xFDRGDm2omauVdKKLWBwbD1riko9iS4wsffhZdwObha');
...
CREATE TABLE `emergency_patients` (
  ...
  `phone` varchar(20) DEFAULT NULL,
  `triage_priority` enum('low','medium','high','critical') NOT NULL,
...
CREATE TABLE `users` (
  ...
  `email` varchar(100) NOT NULL,
  `phone` varchar(20) DEFAULT NULL,
  `role` enum('doctor','nurse','technician','admin_staff') NOT NULL,
  `password` varchar(255) NOT NULL,
  `created_at` datetime DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
